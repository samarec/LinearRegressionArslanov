...
public class GradientDescentCostFunctionMinimizerTest {
	...
	@Test
	public void testMinimizeCostFunctionOneFeature1() throws IOException {
	...
	public void testMinimizeCostFunctionOneFeature() throws IOException {
		GradientDescentCostFunctionMinimizer minimizer = new GradientDescentCostFunctionMinimizer(0.01, 1500, false);
		DoubleMatrix dataMatrix = DoubleMatrix.loadCSVFile("D:\\MagistrLabs\\LinearRegressionArslanov\\src" +
				"\\main\\resources\\linearregression\\ex1data1.txt");
		...
		DoubleMatrix theta = minimizer.minimizeCostFunction(features, values);
		System.out.println(theta.get(0, 0)); //-3.6302914394044015
		System.out.println(theta.get(1, 0)); //1.1663623503355864
	}
//
//	@Test
